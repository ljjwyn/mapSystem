...
public class MapHelper {
     ...
     */
    @Async
    public double getDistance(double firstLatitude, double firstLongitude,
        ...
        result = Double.valueOf(df.format(result*1000));
        return result;
    }
     ...
     * @return 返回两点之间的距离，单位：公里/千米
     */
    public double GetPointDistance(String firstPoint, String secondPoint) {
